package com.basaki.example.postgres.spring.jsonb.data.entity;
...
public class BookEntity implements Serializable {
    ...
    @Type(type = "com.basaki.example.postgres.spring.jsonb.data.entity.PGEnumUserType",
    ...
    @Type(type = "com.basaki.example.postgres.spring.jsonb.data.entity.JsonbUserType",
